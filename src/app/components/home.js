...
export default function Home({ darkMode }) {
  const headingText = "Your Business Will Appear First Time When They Googling";
        ...
        <div className="w-full max-w-7xl mx-auto">
          ...
          <div className="flex flex-col items-center justify-center w-full h-full">
            ...
            >
              ...
              >
               We help you appear on the first page with a fast, elegant, and SEO-friendly website.
            ...
            >
              ...
              >
                <span>No login reuqired </span>
                <div className={`w-1 h-1 rounded-full ${
                  darkMode ? "bg-gray-600" : "bg-gray-400"
                }`}></div>
                <span>Accessible from all devices</span>
              </motion.div>
            </motion.div>     
          </div>
        </div>
